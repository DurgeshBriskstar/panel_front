...
// type
import { UploadAvatar, UploadMultiFile, UploadSingleFile, RemoveSingleFile } from '../upload';
...
RHFRemoveSingleFile.propTypes = {
  name: PropTypes.string,
  onRemove: PropTypes.func,
};

export function RHFRemoveSingleFile({ name, onRemove, ...other }) {
  const { control } = useFormContext();
  return (
    <Controller
      name={name}
